...
<div class="d-sm-flex align-items-center justify-content-between mb-4">
    <h1 class="h3 mb-0 text-gray-800">Inactive Athletes</h1>
    <a href="/export-inactive" class="btn btn-sm btn-outline-secondary"><i class="bi bi-download pr-2"></i>Export</a>
</div>
